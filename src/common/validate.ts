...
const validateEmail = Yup.string().email('Email is not valid').required('Email is required');
...
const validateName = Yup.string().min(2, 'Name is too short').max(100, 'Name is too long').required('Name is required');
